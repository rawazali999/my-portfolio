    ...
    >
      ...
      <div className="flex w-full flex-col gap-4 rounded-lg px-6 shadow-lg sm:w-3/4 lg:w-1/2 ">
        <form onSubmit={handleSubmit}>
          <h2 className="mb-6 text-xl font-bold leading-tight lg:text-4xl ">
            Contact Me ! 📧
          </h2>
          <div>
            <div>
            ...
            <div className="mt-8">
              <button
                type="submit"
                className="focus:shadow-outline w-full rounded-lg bg-gradient-to-br from-sky-500 to-cyan-400 p-3 text-sm font-bold uppercase tracking-wide text-gray-100 focus:outline-none"
              >
                Send Message
              </button>
            </div>
